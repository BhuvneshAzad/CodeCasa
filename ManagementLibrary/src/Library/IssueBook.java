     ...
     public void actionPerformed(ActionEvent e) {
         if(e.getSource()==bt1){
             ...
             try{
                 ...
                 if(qnt<=0)
                 {
                     JOptionPane.showMessageDialog(null,"Book quantity is less ! can not issue");
                     this.setVisible(false);
                     
                 }  
                 else{
                     String q2= "insert into issuedbook(BookId,bookno,bookname,studentId,studentname,studentcontact,date) values('"+id+"','"+bookno+"','"+bookname+"','"+stuid+"','"+stuname+"','"+stucont+"','"+date+"')";
                     String q3= "update addbook set issuedbook=issuebook+1 where id='"+id+"";
